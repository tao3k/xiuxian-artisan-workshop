#!/usr/bin/env python3
"""Category-specific reproduction command builders for memory CI gate triage."""
...
def append_category_commands(
    ...
    *,
    ...
    """Append category-specific repro commands in deterministic order."""
