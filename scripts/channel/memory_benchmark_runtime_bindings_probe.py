#!/usr/bin/env python3
"""Probe/signal bindings for memory benchmark runtime entrypoint."""
...
def run_probe(
    ...
    *,
    ...
    return execution_module.run_probe(
        config,
        prompt=prompt,
...
def parse_turn_signals(
    ...
    *,
    ...
    return execution_module.parse_turn_signals(
        lines,
...
def build_turn_result(
    *,
    ...
    return execution_module.build_turn_result(
        mode=mode,
        iteration=iteration,
