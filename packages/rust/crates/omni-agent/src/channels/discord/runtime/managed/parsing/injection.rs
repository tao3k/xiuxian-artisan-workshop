...
use super::{CommandOutputFormat, SessionInjectionAction, SessionInjectionCommand};

pub(super) fn parse_session_injection_command(input: &str) -> Option<SessionInjectionCommand> {
